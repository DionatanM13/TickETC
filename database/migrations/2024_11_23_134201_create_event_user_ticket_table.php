...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('event_user_ticket', function (Blueprint $table) {
            ...
            $table->foreignId('event_id')->constrained()->onDelete('cascade'); // Relaciona com eventos
            $table->foreignId('ticket_id')->constrained()->onDelete('cascade'); // Relaciona com tickets
            $table->timestamps();
        });
